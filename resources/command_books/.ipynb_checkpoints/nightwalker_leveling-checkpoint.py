...
class _HorizontalAttack(Command):
    ...
    def main(self):
        ...
        for _ in range(self.repetitions):
            _press_skill(self.KEY, self.attacks, up_time=0.05)
